                ...
                <div className="flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-6">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <button
                      ...
                      className="p-2 glass-card text-destructive"
                    >
          ...
          <div className="lg:col-span-1">
            <div className="glass-panel sticky top-24">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex justify-between">
                  <span className="text-muted-foreground">
                    {t("subtotal")} ({cartItemsCount} items)
                  </span>
              ...
              {authUser && (
                <Link
                  to="/payment"
                  className="w-full block text-center py-4 gradient-primary text-primary-foreground rounded-lg font-semibold mb-4"
                >
                  {t("proceedCheckout")}
                </Link>
              )}
              ...
              <Link
                to="/products"
                className="w-full block text-center py-4 bg-secondary text-foreground rounded-lg font-semibold mb-4 border-border hover:bg-accent"
              >
                {t("continueShopping")}
              </Link>
            </div>
