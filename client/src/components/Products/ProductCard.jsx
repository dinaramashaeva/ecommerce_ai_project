...
const ProductCard = ({ product }) => {
  ...
  return (
    <Link
      ...
      className="glass-card animate-smooth group"
    >
      <div className="relative overflow-hidden rounded-lg mb-4">
        ...
        <button
          ...
          className="absolute bottom-3 right-3 p-2 glass-card animate-smooth opacity-0 group-hover:opacity-100 transition-opacity"
