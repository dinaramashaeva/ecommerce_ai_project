      ...
      <div className="fixed right-0 top-0 h-full w-96 z-50 glass-panel animate-slide-in-right overflow-y-auto">
        ...
        <div className="p-6">
          ...
          <button
            ...
            className="flex items-center justify-center space-x-2 w-full p-3 rounded-lg bg-destructive/10 text-destructive hover:bg-destructive/20 transition-colors"
          >
