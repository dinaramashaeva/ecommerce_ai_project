      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            <h2 className="text-2xl font-bold text-primary mb-4">BuyWise</h2>
        ...
        <div className="glass-panel mb-12">
          ...
          <form className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            ...
            <button
              type="submit"
              className="px-6 py-3 gradient-primary text-primary-foreground rounded-lg font-semibold"
            >
              Subscribe
            </button>
          </form>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-border">
          <div className="flex items-center space-x-4 mb-4 md:mb-0">
            {socialLinks.map((social) => {
              ...
              return (
                <a key={social.label} href={social.href} aria-label={social.label} className="p-2 glass-card">
          ...
          <div className="text-center md:text-right">
            <p className="text-muted-foreground text-sm">
              2025 BuyWise. {t("allRightsReserved")}
            </p>
