...
export const fetchAllProducts = (page) => async (dispatch) => {
  ...
  await axiosInstance
    ...
    .then((res) => {
      dispatch(productsSlice.actions.getAllProductsSuccess(res.data));
    })
    .catch((error) => {
      dispatch(productsSlice.actions.getAllProductsFailed());
    });
};
...
export const updateProduct = (data, id) => async (dispatch) => {
  ...
  await axiosInstance
    ...
    .then((res) => {
      dispatch(
        productsSlice.actions.updateProductSuccess(res.data.updatedProduct)
      );
